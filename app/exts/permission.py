...
"""
    ...
    Example:
    >>> from exts.permission import UserNeed, RoleNeed, ItemNeed
    >>> from exts.permission
...
__all__ = ['UserNeed', 'RoleNeed', 'ItemNeed',
           'Permission', 'Identity', 'AnonymousIdentity']
...
class IdentityContext(object):
    ...
    note:: The principal is usually created by the flaskext.Permission.require
...
class Permission(object):
    ...
    def allows(self, identity):
        ...
        """
        logger.info(self.needs)
        logger.info(self.excludes)
        logger.info(identity.provides)
        logger.info(self.needs.intersection(identity.provides))
